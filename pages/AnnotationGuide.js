		...
		return (
			<Layout title="Annotation Guide" page="/annotation_guide" >
				...
				<div>
					...
					Below is a summary of the key points required for the three types of evidence types. 
					...
					<Table striped bordered hover>
						...
						<tbody>
							...
							<tr>
								...
								<td>Gene, Cancer & Optional Drug</td>
								<td>Describes a genomic/transcriptomic aberration that correlates with survival/outcome for a particular cancer type with or without a particular drug.</td>
							</tr>
