...
const WeakPredictions = () => {
	...
	return <Layout title="Weak Predictions" page="/weak_predictions" >
		
				<div className="d-sm-flex align-items-center justify-content-between mb-4 titlepadding">
					<h1 className="h3 mb-0 text-gray-800">Weak Predictions</h1>
				</div>
...
export default WeakPredictions
